...
////////////////////////////////////
  ...
  tamerUser.setAuthor('Click here to join the support server!', `${message.author.avatarURL}`)
  ...
  commonUser.setAuthor('Click here to join the support server!', `${message.author.avatarURL}`)
