...
client.on('channelPinsUpdate', (channel, time) => {
  channel.guild.defaultChannel.sendMessage(`**The pins of __${channel}__ have been updated ${message.guild.emojis.find('name', 'kanna')}**`);
});
client.on('guildCreate', guild => {
  guild.defaultChannel.sendMessage(`**Thanks for adding me here! I hope __${guild.name}__ have loads of insects!\n\nDo \`k!about\` to know a bit about me!\n\nAlso you can see all commands with \`k!help\`!\n\nJoin my support server if you have any questions!\nhttps://discord.gg/uBdXdE9\n\nOh and add my emoji to your server! \`https://cdn.discordapp.com/emojis/282721376320618497.png\` and call it kanna so i can show myself! \(Some commands will appear undefined somewhere because they have that emoji\)**`)
  names[guild.id] = {
    firstName: "Kanna",
    lastName: "Kobayashi",
...
//////////EVERYONE CAN DO //////////
  ...
  if (message.content.startsWith(prefix + 'ping')) {
    message.channel.sendMessage('Eating insects...').then(msg => {
      msg.edit(`I took \`${msg.createdTimestamp - message.createdTimestamp} ms\` to eat all of them! ${message.guild.emojis.find('name', 'kanna')}`);
      return;
    });
    ...
    message.channel.sendMessage(`Invite me to your server ${message.author}! ${message.guild.emojis.exists('name', 'kanna')}\nhttps://discordapp.com/oauth2/authorize?permissions=1341643977&scope=bot&client_id=297459926505095180`)
  };
